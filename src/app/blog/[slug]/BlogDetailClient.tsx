...
export default function BlogDetailClient({ post, related }: BlogDetailClientProps) {
  ...
  return (
    <>
      ...
      <section className="relative pt-28 pb-16 overflow-hidden">
        <div
          ...
          style={{
            ...
            background: `radial-gradient(circle, ${post.gradientFrom.replace("0.3", "0.15").replace("0.25", "0.12").replace("0.2", "0.10")}, transparent 55%)`,
          }}
          aria-hidden="true"
        />
      ...
      {/* Article body */}
      <article className="max-w-[820px] mx-auto px-6 pb-24" aria-label={`Article: ${post.title}`}>
        ...
        <motion.div
          initial="hidden" whileInView="visible" viewport={viewportOnce} variants={fadeUp}
          className="mt-16 liquid-glass rounded-2xl p-8 text-center relative overflow-hidden"
        >
          <div
          ...
          <div className="relative">
            ...
            <h3 className="font-display font-bold text-2xl text-[#F4F7FB] mb-4">See Nexus in action.</h3>
